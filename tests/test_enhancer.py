...
def test_enhance_removes_quotes(enhancer) -> None:
...
def test_enhance_general_error_handling(enhancer) -> None:
...
def test_network_error_handling(enhancer) -> None:
    """Checks that ModelNetworkError is raised when there is no internet connection."""
    with patch.object(enhancer.model, 'generate_content',
...
def test_api_key_error_handling(enhancer) -> None:
